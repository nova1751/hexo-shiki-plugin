export const BUILTIN_THEMES = new Map<string, string>([
  [
    "one-dark-pro",
...
export function resolveThemeStyle(theme?: string): string {
  return BUILTIN_THEMES.get(theme ?? "") ?? BUILTIN_THEMES.get("one-dark-pro")!;
}
